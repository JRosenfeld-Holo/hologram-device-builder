...
import { ChevronRight, Check, ArrowLeft, ArrowRight, Leaf, Droplets, Sun, Wind, Radio, Shield, Battery, Zap } from "lucide-react";
    ...
    return (
        <>
            ...
            <BuildGuideShell steps={steps}>
                ...
                <section id="sensors" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Select Your Sensors" stepNumber={1} />
                    ...
                    <MarkCompleteButton stepId="sensors" />
                </section>

                {/* ── STEP 2: Connectivity ── */}
                <section id="connectivity" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Choose Your Connectivity" stepNumber={2} />
                ...
                <section id="hardware" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Design Your Hardware" stepNumber={3} />
                ...
                {/* ── STEP 4: Solar & Power ── */}
                <section id="power" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Solar Harvesting & Power Management" stepNumber={4} />
                    ...
                    <MarkCompleteButton stepId="power" />
                </section>

                {/* ── STEP 5: Firmware ── */}
                <section id="firmware" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Write Your Firmware" stepNumber={5} />
                ...
                <section id="lifecycle" className="scroll-mt-24 pb-16">
                    <SectionHeader label="Deploy & Maintain" stepNumber={6} />
                    ...
                    <MarkCompleteButton stepId="lifecycle" />
                </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between pt-6 border-t border-[#3A3C46]/30 mb-16 mt-8">
                    <Link href="/build/smart-building" className="inline-flex items-center gap-2 text-sm text-white/40 hover:text-white transition-colors cursor-pointer">
                        <ArrowLeft size={16} /> Prev: Smart Building
                    </Link>
                    <Link href="/build/micromobility" className="inline-flex items-center gap-2 text-sm font-medium text-[#BFFD11] hover:gap-3 transition-all duration-200 cursor-pointer">
                        Next: Micromobility <ArrowRight size={16} />
                    </Link>
                </div>
                <FreePilotCTA />
            </div>
