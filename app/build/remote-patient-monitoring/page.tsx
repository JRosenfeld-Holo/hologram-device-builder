...
import { ChevronRight, Check, ArrowLeft, ArrowRight, HeartPulse, Cpu, Activity, Radio, Lock } from "lucide-react";
        ...
        <>
            ...
            <BuildGuideShell steps={steps}>
                ...
                <section id="hardware" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Hardware Design & Sensing" stepNumber={2} />
                ...
                <section id="firmware" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Firmware Development" stepNumber={3} />
                ...
                <section id="connectivity" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Connectivity & Security" stepNumber={4} />
                        ...
                        <div className="space-y-2">
                            {securityChecklist.map((item, idx) => (
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 p-3 rounded-lg text-left transition-colors cursor-pointer hover:bg-white/[0.03]"
                                >
                ...
                <section id="cloud" className="scroll-mt-24 pb-16 border-b border-[#3A3C46]/20">
                    <SectionHeader label="Cloud Integration & Data Flow" stepNumber={5} />
                    ...
                    <MarkCompleteButton stepId="cloud" />
                </section>

                {/* ── STEP 6: Compliance & Deploy ── */}
                <section id="compliance" className="scroll-mt-24 pb-16">
                    <SectionHeader label="Compliance & Deployment" stepNumber={6} />
                    ...
                    <MarkCompleteButton stepId="compliance" />
                </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between pt-6 border-t border-[#3A3C46]/30 mb-16 mt-8">
                    <Link href="/build/micromobility" className="inline-flex items-center gap-2 text-sm text-white/40 hover:text-white transition-colors cursor-pointer">
                        <ArrowLeft size={16} /> Prev: Micromobility
                    </Link>
                    <Link href="/build" className="inline-flex items-center gap-2 text-sm font-medium text-[#BFFD11] hover:gap-3 transition-all duration-200 cursor-pointer">
                        All Build Guides <ArrowRight size={16} />
                    </Link>
                </div>
                <FreePilotCTA />
            </div>
